        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-8 text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button className="px-7 py-4 bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white font-semibold rounded-2xl shadow-lg shadow-blue-600/15 hover:shadow-xl hover:shadow-blue-600/20 hover:-translate-y-0.5 transition-all duration-200 cursor-pointer text-center">
                Find a Mentor
              </button>
              <button className="px-7 py-4 bg-white border-2 border-slate-200 hover:border-slate-300 text-slate-700 font-semibold rounded-2xl hover:bg-slate-50 active:bg-slate-100 transition-all duration-200 cursor-pointer text-center">
                Become a Mentor
              </button>
            </div>
          ...
          <div className="lg:col-span-5 relative flex justify-center">
            ...
            <div className="w-full max-w-md bg-white border border-slate-100 rounded-3xl shadow-xl shadow-slate-100/80 p-6 md:p-8 space-y-6 relative hover:shadow-2xl hover:shadow-slate-100 transition-shadow duration-300">
              ...
              {/* Booking Button */}
              <button className="w-full py-3 bg-slate-900 hover:bg-slate-800 text-white font-semibold rounded-xl transition-colors duration-200 flex items-center justify-center gap-2 cursor-pointer text-sm">
